...
def epsilon_greedy(Q,
    ...
    if eps_type == 'constant':
        ...
        # It is recommended you use the np.random module
        scheduler = ScheduleLinear(anneal_timesteps, epsilon_initial, epsilon_final)
    ...
    def q_learning(self):
        ...
        while episode <= self.episode_max:
            ...
            while not end_episode:
                ...
                action = epsilon_greedy(Q, s_current, list_pos, current_total_steps, self.epsilon_initial, self.epsilon_final, self.annealing_timesteps)
                # ADD YOUR CODE SNIPPET BETWEEN EX 2.1 and 2.2
                ...
                steps += 1
                if R_total > highestReward and R == self.settings.rewards[0]:
                    Q_highest = Q
                    highestReward = R_total
                    break
            # ADD YOUR CODE SNIPPET BETWEEN EX. 2.3
...
class ScheduleLinear(object):
    ...
    def value(self, t):
        ...
        # Return the annealed linear value of epsilon
        delta_epsilon = self.final_p - self.initial_p
        return self.initial_p + (delta_epsilon * (t / self.schedule_timesteps))
        # ADD YOUR CODE SNIPPET BETWEEN EX 3.2